<?php get_header(); ?>
	<div id="content">
		<nav id="content_menu">
		<ul>
			<li><a href="" class="content_menu_selected">Recent</a></li>
			<li><a href="" >Popular</a></li>
			<li><a href="" >Categories</a></li>
		</ul>
		<div id="languette"><></div>
		</nav>
		
		<?php $pictos = new WP_Query('post_type=pictos&posts_per_page=-1'); 
			if($pictos->have_posts()) : while($pictos->have_posts()) : $pictos-> the_post();
			?>		
			<div class="one_div_item">
				<div class="love_item">0</div>
				<div class="picto">
