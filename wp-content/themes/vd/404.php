...
<h1  id="titre404" class="p404">404</h1>
<div id="frame404" class="frame">
    <div></div>
    <div></div>
    <div></div>
</div>
...
function delete404(){
   setTimeout(function() {
	var el1 = document.getElementById("titre404");
	var el2 = document.getElementById("frame404");
	var el3 = document.getElementById("canvas");
